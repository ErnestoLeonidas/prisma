            ...
            <ul class="list-unstyled components">                
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="mantencionSubmenu">
                        <li>
                            <a href="m_localidades.php">Localidades</a>
                        </li>
                        <li>
                            <a href="m_proyectos.php">Proyectos</a>
                        </li>
                        <li>
                            <a href="m_areas.php">Áreas</a>
                        </li>
                        <li>
                            <a href="m_trabajadores.php">Trabajadores</a>
                        </li>
                        <li>
                            <a href="m_mandantes.php">Mandantes</a>
                        </li>
                        <li>
                            <a href="m_especialidades.php">Especialidades</a>
                        </li>
